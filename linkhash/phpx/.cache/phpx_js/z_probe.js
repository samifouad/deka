...
let s = "{\"owner\":\"linkhash-admin\",\"repos\":[\"a\",\"b\"]}";
globalThis.s = s;
let d = json_decode(s, true);
globalThis.d = d;
(globalThis.__dekaPrint ? globalThis.__dekaPrint((("type=" + globalThis.gettype(d)) + "\n")) : console.log((("type=" + globalThis.gettype(d)) + "\n")));
let owner = null;
globalThis.owner = owner;
let repos = null;
globalThis.repos = repos;
if ((globalThis.is_array(d) && globalThis.array_key_exists("owner", d))) {
owner = d["owner"];
}
if ((globalThis.is_object(d) && ((d.owner !== undefined && d.owner !== null)))) {
owner = d.owner;
}
if ((globalThis.is_array(d) && globalThis.array_key_exists("repos", d))) {
repos = d["repos"];
}
if ((globalThis.is_object(d) && ((d.repos !== undefined && d.repos !== null)))) {
repos = d.repos;
}
(globalThis.__dekaPrint ? globalThis.__dekaPrint((((("ownerType=" + globalThis.gettype(owner)) + " owner=") + ("" + owner)) + "\n")) : console.log((((("ownerType=" + globalThis.gettype(owner)) + " owner=") + ("" + owner)) + "\n")));
(globalThis.__dekaPrint ? globalThis.__dekaPrint((("reposType=" + globalThis.gettype(repos)) + "\n")) : console.log((("reposType=" + globalThis.gettype(repos)) + "\n")));
if ((globalThis.is_array(repos) || globalThis.is_object(repos))) {
for (const [k , v] of Object.entries(repos)) {
(globalThis.__dekaPrint ? globalThis.__dekaPrint((((("repo[" + ("" + k)) + "]=") + ("" + v)) + "\n")) : console.log((((("repo[" + ("" + k)) + "]=") + ("" + v)) + "\n")));
}
}
for (const [k , v] of Object.entries(d)) {
(globalThis.__dekaPrint ? globalThis.__dekaPrint((((("k=" + ("" + k)) + " t=") + globalThis.gettype(v)) + "\n")) : console.log((((("k=" + ("" + k)) + " t=") + globalThis.gettype(v)) + "\n")));
}
};
await __phpx_main();

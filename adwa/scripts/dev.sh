...
USE_LSP_SIDECAR="${PHPX_LSP_SIDECAR:-1}"
...
echo "[adwa-dev] serving $ROOT_DIR/website at http://localhost:${DEV_PORT}"
exec python3 -m http.server "$DEV_PORT" --directory "$ROOT_DIR/website"

...
export interface InitOutput {
    ...
    readonly init: () => void;
    readonly wasm_bindgen__closure__destroy__h693ef49db1eea759: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hff144dd9f735d051: (a: number, b: number, c: any, d: any) => any;
    readonly wasm_bindgen__convert__closures_____invoke__h4b5fbaac19fbe386: (a: number, b: number, c: any) => any;

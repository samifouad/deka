...
const { op_php_get_wasm, op_php_parse_phpx_types, op_php_read_file_sync, op_php_write_file_sync, op_php_mkdirs, op_php_sha256, op_php_read_env, op_php_cwd, op_php_file_exists, op_php_path_resolve, op_php_read_dir, op_php_parse_wit } = Deno.core.ops;
const console = {
    log: (...args)=>{

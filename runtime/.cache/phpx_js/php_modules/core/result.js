...
class Result {
  constructor(__case, __payload) {
    this.__enum = "Result";
    this.__case = __case;
    if (__payload) {
      Object.assign(this, __payload);
    }
  }
  is_ok() {
return (((this instanceof Result && this.__case === "Ok")) ? true : (((this instanceof Result && this.__case === "Err")) ? false : undefined));
  }
  is_err() {
return (((this instanceof Result && this.__case === "Ok")) ? false : (((this instanceof Result && this.__case === "Err")) ? true : undefined));
  }
  unwrap() {
return (((this instanceof Result && this.__case === "Ok")) ? this.value : (((this instanceof Result && this.__case === "Err")) ? globalThis.panic(("Result is error: " + globalThis.json_encode(this.error))) : undefined));
  }
  expect(message) {
return (((this instanceof Result && this.__case === "Ok")) ? this.value : (((this instanceof Result && this.__case === "Err")) ? globalThis.panic(message) : undefined));
  }
  unwrap_or(fallback) {
return (((this instanceof Result && this.__case === "Ok")) ? this.value : (((this instanceof Result && this.__case === "Err")) ? fallback : undefined));
  }
  unwrap_or_else(fn) {
return (((this instanceof Result && this.__case === "Ok")) ? this.value : (((this instanceof Result && this.__case === "Err")) ? fn(this.error) : undefined));
  }
  static Ok(value) { return new Result("Ok", {"value": value}); }
  static Err(error) { return new Result("Err", {"error": error}); }
}
...
globalThis.panic("Result::unwrap expected Result");
}
...
if ((!globalThis.class_exists("Result", false))) {
globalThis.class_alias(("" + "\\Result"), "Result");
}
};
await __phpx_main();

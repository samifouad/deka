...
class Option {
  ...
  is_some() {
return (((this instanceof Option && this.__case === "Some")) ? true : (((this instanceof Option && this.__case === "None")) ? false : undefined));
  }
  is_none() {
return (((this instanceof Option && this.__case === "Some")) ? false : (((this instanceof Option && this.__case === "None")) ? true : undefined));
  }
  unwrap() {
return (((this instanceof Option && this.__case === "Some")) ? this.value : (((this instanceof Option && this.__case === "None")) ? globalThis.panic("Option::unwrap on None") : undefined));
  }
  expect(message) {
return (((this instanceof Option && this.__case === "Some")) ? this.value : (((this instanceof Option && this.__case === "None")) ? globalThis.panic(message) : undefined));
  }
  unwrap_or(fallback) {
return (((this instanceof Option && this.__case === "Some")) ? this.value : (((this instanceof Option && this.__case === "None")) ? fallback : undefined));
  }
  unwrap_or_else(fn) {
return (((this instanceof Option && this.__case === "Some")) ? this.value : (((this instanceof Option && this.__case === "None")) ? fn() : undefined));
  }
  static Some(value) { return new Option("Some", {"value": value}); }
  static get None() { return new Option("None", null); }
}
...
globalThis.panic("Option::unwrap expected Option");
}


const __phpx_main = async () => {
if ((!globalThis.class_exists("Option", false))) {
globalThis.class_alias(("" + "\\Option"), "Option");
}
};
await __phpx_main();

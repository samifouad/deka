...
if (globalThis.function_exists("__bridge")) {
return globalThis.__bridge(kind, action, payload);
}
return globalThis.__deka_wasm_call(("__deka_" + ("" + kind)), ("" + action), payload);
}

export function bridge_async(kind, action, payload) {
if (payload === undefined) { payload = {}; }
if (globalThis.function_exists("__bridge_async")) {
return globalThis.__bridge_async(kind, action, payload);
}
return globalThis.__deka_wasm_call_async(("__deka_" + ("" + kind)), ("" + action), payload);
}

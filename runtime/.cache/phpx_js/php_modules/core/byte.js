...
export function byte_from_char(ch) {
if (((ch === null) || (ch === ""))) {
return null;
}
return globalThis.__deka_ord(ch);
}

export function byte_to_char(byte) {
if ((byte === null)) {
return null;
}
return globalThis.__deka_chr(byte);
}

export function byte_is_whitespace(byte) {
if ((byte === null)) {
return false;
}
...
export function byte_is_digit(byte) {
if ((byte === null)) {
return false;
}
...
export function byte_is_hex(byte) {
if ((byte === null)) {
return false;
}
if (((byte >= 48) && (byte <= 57))) {

...
let out = [];
let nextIntKey = 0;
for (const arr of (Array.isArray(args) ? args : Object.values((args ?? {})))) {
if ((!globalThis.is_array(arr))) {
return null;
}
for (const [key , value] of Object.entries(arr)) {
if (globalThis.is_int(key)) {
...
if ((!globalThis.is_array(left))) {
return [left, right];
}
if ((!globalThis.is_array(right))) {
let out = [];
for (const value of (Array.isArray(left) ? left : Object.values((left ?? {})))) {
(() => { const __arr = out; const __val = value; __arr.push(__val); return __val; })();
}
(() => { const __arr = out; const __val = right; __arr.push(__val); return __val; })();
return out;
}
let out = [];
let nextIntKey = 0;

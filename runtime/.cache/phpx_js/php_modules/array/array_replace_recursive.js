...
if (((__deka_array_has_key(out, key) && globalThis.is_array(out[key])) && globalThis.is_array(value))) {
...
if (((!globalThis.is_array(left)) || (!globalThis.is_array(right)))) {
return right;
}
let out = [];

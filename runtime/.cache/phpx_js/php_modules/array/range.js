...
let out = [];
if ((((globalThis.is_string(start) && globalThis.is_string(end)) && (globalThis.strlen(start) === 1)) && (globalThis.strlen(end) === 1))) {
let startCode = globalThis.ord(start);
let endCode = globalThis.ord(end);
if ((startCode <= endCode)) {
let value = startCode;
while ((value <= endCode)) {
(() => { const __arr = out; const __val = globalThis.chr(value); __arr.push(__val); return __val; })();
(value += stepValue);
}
} else {
let value = startCode;

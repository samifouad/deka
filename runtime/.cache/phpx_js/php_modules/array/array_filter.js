...
export function array_filter(array, callback, mode) {
...
for (const [key , value] of Object.entries(array)) {
if (useKey) {
let result = globalThis.call_user_func(callback, key);
} else {
if (useBoth) {
let result = globalThis.call_user_func(callback, value, key);
} else {
let result = globalThis.call_user_func(callback, value);
}
}
if (globalThis.result) {
(out[key] = value);
}
}
return out;

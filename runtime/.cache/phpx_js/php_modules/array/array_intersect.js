...
export function array_intersect(array) {
...
(() => { const __arr = otherValues; const __val = __deka_array_value_to_string(value); __arr.push(__val); return __val; })();
}
}
let out = [];
...
let found = false;
for (const other of (Array.isArray(otherValues) ? otherValues : Object.values((otherValues ?? {})))) {
if ((other === valStr)) {
found = true;
break;
}

...
export function array_pad(array, length, value) {
if ((globalThis.__phpx_func_num_args(arguments) !== 3)) {
return null;
}
...
let values = [];
for (const item of (Array.isArray(array) ? array : Object.values((array ?? {})))) {
(() => { const __arr = values; const __val = item; __arr.push(__val); return __val; })();
}
let target = globalThis.abs(Number.parseInt(length, 10));
if ((target <= globalThis.count(values))) {
return values;
}
let padCount = (target - globalThis.count(values));
if ((Number.parseInt(length, 10) >= 0)) {
...
let padded = [];
for (let i = 0; (i < padCount); (i += 1)) {
(() => { const __arr = padded; const __val = value; __arr.push(__val); return __val; })();
}
for (const item of (Array.isArray(values) ? values : Object.values((values ?? {})))) {
(() => { const __arr = padded; const __val = item; __arr.push(__val); return __val; })();
}
values = padded;
}
return values;

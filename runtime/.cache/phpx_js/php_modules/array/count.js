...
export function count(value, mode) {
...
count = 0;
for (const _ of (Array.isArray(value) ? value : Object.values((value ?? {})))) {
(count += 1);
}
return count;
}

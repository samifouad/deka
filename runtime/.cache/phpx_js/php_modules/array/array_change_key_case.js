...
export function array_change_key_case(array, case_) {
if (case_ === undefined) { case_ = globalThis.CASE_LOWER; }
...
let mode = ((argc === 2) ? Number.parseInt(case_, 10) : globalThis.CASE_LOWER);
let out = [];
for (const [key , value] of Object.entries(array)) {
if (globalThis.is_string(key)) {
if ((mode === globalThis.CASE_UPPER)) {
key = globalThis.strtoupper(key);
} else {
key = globalThis.strtolower(key);
}
}
(out[key] = value);
}

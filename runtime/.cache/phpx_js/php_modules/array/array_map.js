...
let arr = args[i];
if ((!globalThis.is_array(arr))) {
return null;
}
let values = [];
if ((i === 1)) {
for (const [key , value] of Object.entries(arr)) {
(() => { const __arr = firstKeys; const __val = key; __arr.push(__val); return __val; })();
(() => { const __arr = values; const __val = value; __arr.push(__val); return __val; })();
}
} else {
for (const value of (Array.isArray(arr) ? arr : Object.values((arr ?? {})))) {
(() => { const __arr = values; const __val = value; __arr.push(__val); return __val; })();
}
}
(() => { const __arr = arrays; const __val = values; __arr.push(__val); return __val; })();
}
let out = [];
let count = globalThis.count(firstKeys);
for (let index = 0; (index < count); (index += 1)) {
let params = [];
for (const values of (Array.isArray(arrays) ? arrays : Object.values((arrays ?? {})))) {
(() => { const __arr = params; const __val = (((values[index] !== undefined && values[index] !== null)) ? values[index] : null); __arr.push(__val); return __val; })();
}
if ((callback === null)) {
let row = [];
for (const param of (Array.isArray(params) ? params : Object.values((params ?? {})))) {
(() => { const __arr = row; const __val = param; __arr.push(__val); return __val; })();
}
(out[firstKeys[index]] = row);
} else {
(out[firstKeys[index]] = globalThis.call_user_func_array(callback, params));
}
}
return out;
}

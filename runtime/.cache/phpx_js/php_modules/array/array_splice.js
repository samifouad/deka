...
if ((!globalThis.is_array(array))) {
return null;
}
let values = [];
for (const value of (Array.isArray(array) ? array : Object.values((array ?? {})))) {
(() => { const __arr = values; const __val = value; __arr.push(__val); return __val; })();
}
let len = globalThis.count(values);
let start = Number.parseInt(offset, 10);
if ((start < 0)) {
start = (len + start);
if ((start < 0)) {
start = 0;
...
if ((argc >= 3)) {
let sliceLen = Number.parseInt(length, 10);
} else {
let sliceLen = (len - start);
}
if ((globalThis.sliceLen < 0)) {
let sliceLen = 0;
}
let end = (start + globalThis.sliceLen);
if ((end > len)) {
end = len;
}
let removed = [];
for (let i = start; (i < end); (i += 1)) {
(() => { const __arr = removed; const __val = values[i]; __arr.push(__val); return __val; })();
}
let replacementValues = [];
if ((argc === 4)) {
if (globalThis.is_array(replacement)) {
for (const value of (Array.isArray(replacement) ? replacement : Object.values((replacement ?? {})))) {
(() => { const __arr = replacementValues; const __val = value; __arr.push(__val); return __val; })();
}
} else {
(() => { const __arr = replacementValues; const __val = replacement; __arr.push(__val); return __val; })();
}
}
let out = [];
for (let i = 0; (i < start); (i += 1)) {
(() => { const __arr = out; const __val = values[i]; __arr.push(__val); return __val; })();
}
for (const value of (Array.isArray(replacementValues) ? replacementValues : Object.values((replacementValues ?? {})))) {
(() => { const __arr = out; const __val = value; __arr.push(__val); return __val; })();
}
for (let i = end; (i < len); (i += 1)) {
(() => { const __arr = out; const __val = values[i]; __arr.push(__val); return __val; })();
}
array = out;
return removed;

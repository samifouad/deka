...
export function array_uintersect(array) {
...
(() => { const __arr = otherValues; const __val = value; __arr.push(__val); return __val; })();
}
}
let out = [];
for (const [key , value] of Object.entries(array)) {
let found = false;
for (const otherValue of (Array.isArray(otherValues) ? otherValues : Object.values((otherValues ?? {})))) {
if ((Number.parseInt(globalThis.call_user_func(callback, value, otherValue), 10) === 0)) {
found = true;
break;
}
}

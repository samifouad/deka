...
export function array_reverse(array, preserve_keys) {
if (preserve_keys === undefined) { preserve_keys = false; }
...
(() => { const __arr = keys; const __val = key; __arr.push(__val); return __val; })();
(() => { const __arr = values; const __val = value; __arr.push(__val); return __val; })();
}
let preserve = ((argc === 2) ? Boolean(preserve_keys) : false);
let out = [];
let i = (globalThis.count(keys) - 1);
while ((i >= 0)) {
let key = keys[i];
let value = values[i];
if (preserve) {

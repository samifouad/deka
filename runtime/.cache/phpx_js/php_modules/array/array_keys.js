...
export function array_keys(array, filter_value, strict) {
...
(() => { const __arr = out; const __val = key; __arr.push(__val); return __val; })();
}
return out;
}
let useStrict = ((argc === 3) ? Boolean(strict) : false);
for (const [key , value] of Object.entries(array)) {
if ((useStrict ? (value === filter_value) : (value === filter_value))) {
(() => { const __arr = out; const __val = key; __arr.push(__val); return __val; })();
}
}
return out;

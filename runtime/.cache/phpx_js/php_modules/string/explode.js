...
if ((globalThis.is_array(separator) || globalThis.is_object(separator))) {
return null;
}
...
let sepLen = __deka_strlen_bytes(sep);
...
(() => { const __arr = parts; const __val = __deka_slice_bytes(str, pos, len); __arr.push(__val); return __val; })();
break;
}
let next = __deka_strpos_bytes(str, sep, pos);
if ((next < 0)) {
(() => { const __arr = parts; const __val = __deka_slice_bytes(str, pos, len); __arr.push(__val); return __val; })();
break;
}
(() => { const __arr = parts; const __val = __deka_slice_bytes(str, pos, next); __arr.push(__val); return __val; })();
pos = (next + sepLen);
(count += 1);
if ((pos > len)) {
if (((limitValue === null) || (limitValue > 0))) {
(() => { const __arr = parts; const __val = ""; __arr.push(__val); return __val; })();
}
break;
}
}
if (((limitValue !== null) && (limitValue < 0))) {
let remove = (-limitValue);
let total = count(parts);
if ((remove >= total)) {
return [];
}
let trimmed = [];
for (let i = 0; (i < (total - remove)); (i += 1)) {
(() => { const __arr = trimmed; const __val = parts[i]; __arr.push(__val); return __val; })();
}
return trimmed;
}
return parts;

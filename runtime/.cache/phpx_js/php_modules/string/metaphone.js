...
export function metaphone(string, max_phonemes) {
if (max_phonemes === undefined) { max_phonemes = 0; }
let argc = globalThis.__phpx_func_num_args(arguments);
if (((argc < 1) || (argc > 2))) {
return null;
}
if ((globalThis.is_array(string) || globalThis.is_object(string))) {
return null;
}
let max = ((argc === 2) ? Number.parseInt(max_phonemes, 10) : 0);
if ((max < 0)) {
return null;
}
let inwd = __deka_to_upper_ascii(("" + string));
let inwdLen = __deka_strlen_bytes(inwd);
if ((inwdLen === 1)) {
return inwd;
}
let local = "";
let first = __deka_char_at(inwd, 0);
let second = __deka_char_at(inwd, 1);
...
let wdsz = __deka_strlen_bytes(local);
let code = "";
let skip = 0;
for (let index = 0; (index < wdsz); (index += 1)) {
let symb = __deka_char_at(local, index);
if ((skip > 0)) {
(skip -= 1);
continue;
}
...
if ((symb === "C")) {
let next = __deka_char_at(local, (index + 1));
if ((((__deka_is_previous_char(local, index, "S") && (!__deka_is_last_char(wdsz, index))) && (next !== "")) && __deka_is_frontv(next))) {
} else {
if (__deka_region_match(local, index, "CIA")) {
(code += "X");
} else {
if ((((!__deka_is_last_char(wdsz, index)) && (next !== "")) && __deka_is_frontv(next))) {
(code += "S");
} else {
if ((__deka_is_previous_char(local, index, "S") && __deka_is_next_char(local, index, "H"))) {
(code += "K");
} else {
...
if ((symb === "D")) {
if ((((!__deka_is_last_char(wdsz, (index + 1))) && __deka_is_next_char(local, index, "G")) && __deka_is_frontv(__deka_char_at(local, (index + 2))))) {
(code += "J");
skip = 2;
} else {
(code += "T");
...
if ((symb === "G")) {
if ((((__deka_is_last_char(wdsz, (index + 1)) && __deka_is_next_char(local, index, "H")) || (((!__deka_is_last_char(wdsz, (index + 1))) && __deka_is_next_char(local, index, "H")) && (!__deka_is_vowel(local, (index + 2))))) || ((index > 0) && (__deka_region_match(local, index, "GN") || __deka_region_match(local, index, "GNED"))))) {
} else {
let hard = __deka_is_previous_char(local, index, "G");
if ((((!__deka_is_last_char(wdsz, index)) && __deka_is_frontv(__deka_char_at(local, (index + 1)))) && (!hard))) {
(code += "J");
} else {
(code += "K");
}
...
if ((symb === "H")) {
if ((__deka_is_last_char(wdsz, index) || ((index > 0) && __deka_is_varson(__deka_char_at(local, (index - 1)))))) {
} else {
if (__deka_is_vowel(local, (index + 1))) {
(code += "H");
}
}
} else {
...
if ((symb === "S")) {
if (((__deka_region_match(local, index, "SH") || __deka_region_match(local, index, "SIO")) || __deka_region_match(local, index, "SIA"))) {
(code += "X");
} else {
(code += "S");
}
...
if ((symb === "T")) {
if ((__deka_region_match(local, index, "TIA") || __deka_region_match(local, index, "TIO"))) {
(code += "X");
} else {
if (__deka_region_match(local, index, "TCH")) {
} else {
if (__deka_region_match(local, index, "TH")) {
(code += "0");
} else {
(code += "T");
}
...
let ch = __deka_char_at(text, index);
...
let textLen = __deka_strlen_bytes(text);
let testLen = __deka_strlen_bytes(test);
if ((((index + testLen) - 1) >= textLen)) {
return false;
}
let slice = __deka_slice_bytes(text, index, textLen);

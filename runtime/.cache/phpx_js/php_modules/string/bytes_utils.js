...
let len = 0;
while (((value[len] !== undefined && value[len] !== null))) {
(len += 1);
}
return len;
}
...
export function __deka_strpos_bytes(haystack, needle, offset) {
if (offset === undefined) { offset = 0; }
let hlen = __deka_strlen_bytes(haystack);
let nlen = __deka_strlen_bytes(needle);
if ((nlen === 0)) {
return 0;
}
let start = offset;

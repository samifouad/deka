...
import { __deka_build_format_args_from_array, __deka_format_sprintf_from_args } from './printf_utils.phpx';

if (!globalThis.__phpxStructMethods) { globalThis.__phpxStructMethods = Object.create(null); }
export function vprintf(format, values) {
if ((globalThis.__phpx_func_num_args(arguments) !== 2)) {
return null;
}
let args = __deka_build_format_args_from_array(format, values, "vprintf", 2);
if ((args === null)) {
return null;
}
let formatted = __deka_format_sprintf_from_args(args);
if ((formatted === null)) {
return null;
}
(globalThis.__dekaPrint ? globalThis.__dekaPrint(formatted) : console.log(formatted));
return __deka_strlen_bytes(formatted);
}

...
export function strtok(string, token) {
...
(globalThis.GLOBALS["__deka_strtok_str"] = ("" + string));
(globalThis.GLOBALS["__deka_strtok_pos"] = 0);
(globalThis.GLOBALS["__deka_strtok_delim"] = ("" + token));
return __deka_strtok_next();
}
(globalThis.GLOBALS["__deka_strtok_delim"] = ("" + string));
return __deka_strtok_next();
}

function __deka_strtok_next() {
if ((!((globalThis.GLOBALS["__deka_strtok_str"] !== undefined && globalThis.GLOBALS["__deka_strtok_str"] !== null)))) {
return false;
}
let str = globalThis.GLOBALS["__deka_strtok_str"];
let delim = (((globalThis.GLOBALS["__deka_strtok_delim"] !== undefined && globalThis.GLOBALS["__deka_strtok_delim"] !== null)) ? globalThis.GLOBALS["__deka_strtok_delim"] : "");
let pos = (((globalThis.GLOBALS["__deka_strtok_pos"] !== undefined && globalThis.GLOBALS["__deka_strtok_pos"] !== null)) ? Number.parseInt(globalThis.GLOBALS["__deka_strtok_pos"], 10) : 0);
let len = __deka_strlen_bytes(str);
if ((pos >= len)) {
return false;
}
...
if ((pos >= len)) {
(globalThis.GLOBALS["__deka_strtok_pos"] = pos);
return false;
}
let start = pos;
while (((pos < len) && (!__deka_strtok_is_delim(str[pos], delim)))) {
...
let len = __deka_strlen_bytes(delim);

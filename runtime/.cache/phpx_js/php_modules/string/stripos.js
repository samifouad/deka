...
import { __deka_strpos_bytes, __deka_to_lower_ascii } from './bytes_utils.phpx';

if (!globalThis.__phpxStructMethods) { globalThis.__phpxStructMethods = Object.create(null); }
export function stripos(haystack, needle, offset) {
...
let hs = __deka_to_lower_ascii(("" + haystack));
let nd = __deka_to_lower_ascii(("" + needle));
let off = ((argc === 3) ? Number.parseInt(offset, 10) : 0);
let pos = __deka_strpos_bytes(hs, nd, off);
if ((pos < 0)) {
return false;
}
return pos;

...
if ((argc === 1)) {
if ((!globalThis.is_array(glue))) {
return null;
}
pieces = glue;
glue = "";
} else {
if ((globalThis.is_array(glue) && (!globalThis.is_array(pieces)))) {
let tmp = pieces;
pieces = glue;
glue = ("" + tmp);
} else {
...
if ((!globalThis.is_array(pieces))) {
return null;
}
let out = "";
let first = true;
for (const value of (Array.isArray(pieces) ? pieces : Object.values((pieces ?? {})))) {
if ((!first)) {
(out += glue);
}
(out += ("" + value));

...
if ((globalThis.is_array(data) || globalThis.is_object(data))) {
return null;
}
let input = ("" + data);
...
let j = 0;
while ((j < chunkLen)) {
let b1 = globalThis.ord(input[(i + j)]);
let b2 = (((j + 1) < chunkLen) ? globalThis.ord(input[((i + j) + 1)]) : 0);
let b3 = (((j + 2) < chunkLen) ? globalThis.ord(input[((i + j) + 2)]) : 0);
...
return globalThis.chr(((value & 0x3f) + 32));
}

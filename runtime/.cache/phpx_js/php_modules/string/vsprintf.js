...
export function vsprintf(format, values) {
if ((globalThis.__phpx_func_num_args(arguments) !== 2)) {
return null;
}
let args = __deka_build_format_args_from_array(format, values, "vsprintf", 2);
if ((args === null)) {
return null;
}
return __deka_format_sprintf_from_args(args);
}

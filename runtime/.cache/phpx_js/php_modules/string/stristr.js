...
export function stristr(haystack, needle, before_needle) {
if (before_needle === undefined) { before_needle = false; }
...
let hs = ("" + haystack);
let nd = ("" + needle);
let lowerHs = __deka_to_lower_ascii(hs);
let lowerNd = __deka_to_lower_ascii(nd);
let pos = __deka_strpos_bytes(lowerHs, lowerNd, 0);
if ((pos < 0)) {
return false;
}
...
let len = __deka_strlen_bytes(hs);

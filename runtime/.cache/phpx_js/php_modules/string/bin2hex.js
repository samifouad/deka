...
let byte = globalThis.__deka_ord(str[i]);
let hi = ((byte >> 4) & 15);
let lo = (byte & 15);
(out += __deka_hex_nibble(hi));
(out += __deka_hex_nibble(lo));
}
return out;
}

function __deka_hex_nibble(value) {
if ((value < 10)) {
return globalThis.__deka_chr((48 + value));
}
return globalThis.__deka_chr((87 + value));
}

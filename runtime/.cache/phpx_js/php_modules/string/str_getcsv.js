...
if (enclosure === undefined) { enclosure = "\""; }
...
let sep = ((argc >= 2) ? ("" + separator) : ",");
let enc = ((argc >= 3) ? ("" + enclosure) : "\"");
let esc = ((argc === 4) ? ("" + escape) : "\\");
...
if ((ch === sepChar)) {
(() => { const __arr = fields; const __val = field; __arr.push(__val); return __val; })();
field = "";
continue;
}
if ((ch === encChar)) {

...
export function version_compare(version1, version2, operator) {
if (operator === undefined) { operator = null; }
let argc = globalThis.__phpx_func_num_args(arguments);
if (((argc < 2) || (argc > 3))) {
return null;
}
let v1 = __deka_version_operand(version1);
let v2 = __deka_version_operand(version2);
if (((v1 === null) || (v2 === null))) {
return null;
}
let tokensA = __deka_version_tokens(v1);
let tokensB = __deka_version_tokens(v2);
let ordering = __deka_compare_version_tokens(tokensA, tokensB);
if ((argc === 3)) {
if ((!globalThis.is_string(operator))) {
return null;
}
...
if ((globalThis.is_array(value) || globalThis.is_object(value))) {
return null;
}
...
let byte = globalThis.ord(input[i]);
if (((byte >= 48) && (byte <= 57))) {
if ((kind !== "num")) {
...
__deka_version_flush(tokens, current, kind);
if ((globalThis.count(tokens) === 0)) {
(() => { const __arr = tokens; const __val = {"kind": "num", "value": 0}; __arr.push(__val); return __val; })();
}
return tokens;
}
...
if ((kind === "num")) {
(() => { const __arr = tokens; const __val = {"kind": "num", "value": Number.parseInt(current, 10)}; __arr.push(__val); return __val; })();
} else {
if ((kind === "str")) {
(() => { const __arr = tokens; const __val = {"kind": "str", "value": current}; __arr.push(__val); return __val; })();
}
}
}

function __deka_compare_version_tokens(a, b) {
let lenA = globalThis.count(a);
let lenB = globalThis.count(b);
let max = ((lenA > lenB) ? lenA : lenB);
for (let i = 0; (i < max); (i += 1)) {
let partA = ((i < lenA) ? a[i] : {"kind": "num", "value": 0});
let partB = ((i < lenB) ? b[i] : {"kind": "num", "value": 0});
let cmp = __deka_compare_version_part(partA, partB);
if ((cmp !== 0)) {
return cmp;
}
}
...
let len1 = __deka_strlen_bytes(left);
let len2 = __deka_strlen_bytes(right);
let limit = ((len1 > len2) ? len2 : len1);
for (let i = 0; (i < limit); (i += 1)) {
let b1 = globalThis.ord(left[i]);
let b2 = globalThis.ord(right[i]);
if ((b1 < b2)) {
return (-1);
}
if ((b1 > b2)) {
...
let op = __deka_to_lower_ascii(operator);
if (((op === "<") || (op === "lt"))) {
return (ordering < 0);
}
if (((op === "<=") || (op === "le"))) {

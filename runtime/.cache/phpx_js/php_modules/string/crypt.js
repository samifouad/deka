...
export function crypt(string, salt) {
...
if (((argc === 2) && (globalThis.is_array(salt) || globalThis.is_object(salt)))) {
return null;
}
if ((argc === 1)) {
return globalThis.__deka_crypt(("" + string));
}
return globalThis.__deka_crypt(("" + string), ("" + salt));
}

...
import { __deka_html_escape } from './html_utils.phpx';

if (!globalThis.__phpxStructMethods) { globalThis.__phpxStructMethods = Object.create(null); }
export function htmlspecialchars(string, flags, encoding, double_encode) {
if (flags === undefined) { flags = null; }
if (encoding === undefined) { encoding = null; }
if (double_encode === undefined) { double_encode = null; }
...
let encodeQuotes = true;
let doubleEncode = ((double_encode === null) ? true : Boolean(double_encode));
return __deka_html_escape(("" + string), encodeQuotes, doubleEncode);
}

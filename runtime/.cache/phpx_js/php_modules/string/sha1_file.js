...
export function sha1_file(filename, binary) {
if (binary === undefined) { binary = false; }
let argc = globalThis.__phpx_func_num_args(arguments);
if (((argc < 1) || (argc > 2))) {
return null;
}
if ((globalThis.is_array(filename) || globalThis.is_object(filename))) {
return null;
}
let raw = ((argc === 2) ? Boolean(binary) : false);
return globalThis.__deka_sha1_file(("" + filename), raw);
}

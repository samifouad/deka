...
import { __deka_format_sprintf_from_args } from './printf_utils.phpx';

if (!globalThis.__phpxStructMethods) { globalThis.__phpxStructMethods = Object.create(null); }
export function fprintf(stream, format) {
...
(() => { const __arr = formatArgs; const __val = args[i]; __arr.push(__val); return __val; })();
}
let formatted = __deka_format_sprintf_from_args(formatArgs);
if ((formatted === null)) {
return null;
}
return globalThis.fwrite(stream, formatted);
}

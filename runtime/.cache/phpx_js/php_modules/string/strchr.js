...
export function strchr(haystack, needle, before_needle) {
...
if ((argc === 2)) {
return globalThis.strstr(("" + haystack), ("" + needle));
}
return globalThis.strstr(("" + haystack), ("" + needle), Boolean(before_needle));
}

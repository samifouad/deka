...
let i = 0;
while ((i < len)) {
let lineLen = __deka_uu_dec(globalThis.ord(input[i]));
(i += 1);
if ((lineLen === 0)) {
break;
}
...
let c1 = __deka_uu_dec(globalThis.ord(input[i]));
let c2 = __deka_uu_dec(globalThis.ord(input[(i + 1)]));
let c3 = __deka_uu_dec(globalThis.ord(input[(i + 2)]));
let c4 = __deka_uu_dec(globalThis.ord(input[(i + 3)]));
let b1 = ((c1 << 2) | (c2 >> 4));
let b2 = ((c2 << 4) | (c3 >> 2));
let b3 = ((c3 << 6) | c4);
(out += globalThis.chr(b1));
(written += 1);
if ((written < lineLen)) {
(out += globalThis.chr(b2));
(written += 1);
}
if ((written < lineLen)) {
(out += globalThis.chr(b3));
(written += 1);
}
(i += 4);
}

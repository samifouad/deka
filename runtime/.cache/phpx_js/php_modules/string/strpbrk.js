...
if ((globalThis.is_array(char_mask) || globalThis.is_object(char_mask))) {
return null;
}
let hs = ("" + haystack);
let mask = ("" + char_mask);
...
let set = __deka_trim_build_mask(mask);
let len = __deka_strlen_bytes(hs);
for (let i = 0; (i < len); (i += 1)) {
let byte = globalThis.ord(hs[i]);

...
import { __deka_trim_bytes } from './trim_utils.phpx';

if (!globalThis.__phpxStructMethods) { globalThis.__phpxStructMethods = Object.create(null); }
export function rtrim(string, characters) {
...
let mask = ((argc === 2) ? ("" + characters) : " \n\r\t\u000b\u0000");
let value = ("" + string);
return __deka_trim_bytes(value, mask, false, true);
}

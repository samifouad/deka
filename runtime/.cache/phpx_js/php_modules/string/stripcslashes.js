...
if ((next === "a")) {
(out += globalThis.chr(7));
(i += 2);
continue;
}
if ((next === "b")) {
(out += globalThis.chr(8));
(i += 2);
continue;
}
if ((next === "f")) {
(out += globalThis.chr(12));
(i += 2);
continue;
}
if ((next === "\\")) {
...
if (((next === "x") || (next === "X"))) {
if (((i + 3) < len)) {
let h1 = __deka_hex_value(str[(i + 2)]);
let h2 = __deka_hex_value(str[(i + 3)]);
if (((h1 >= 0) && (h2 >= 0))) {
(out += globalThis.__deka_chr(((h1 << 4) | h2)));
(i += 4);
continue;
}
}
...
(out += globalThis.__deka_chr(__deka_oct_value(oct)));
i = j;
continue;
}
(out += next);
...
let byte = globalThis.__deka_ord(ch);
if (((byte >= 48) && (byte <= 57))) {
return (byte - 48);
}
if (((byte >= 65) && (byte <= 70))) {
...
let byte = globalThis.__deka_ord(digits[i]);
if (((byte < 48) || (byte > 55))) {
break;
}

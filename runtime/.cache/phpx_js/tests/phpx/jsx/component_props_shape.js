...
(globalThis.__dekaPrint ? globalThis.__dekaPrint((globalThis.gettype(props) + "\n")) : console.log((globalThis.gettype(props) + "\n")));
return ((globalThis.is_object(props) && ((props.name !== undefined && props.name !== null))) ? ("" + props.name) : "missing");
}


const __phpx_main = async () => {
(globalThis.__dekaPrint ? globalThis.__dekaPrint((renderToString(jsxs("h1", {"children": ["Hello ", jsx(Hello, {"name": "world"})]})) + "\n")) : console.log((renderToString(jsxs("h1", {"children": ["Hello ", jsx(Hello, {"name": "world"})]})) + "\n")));
};
await __phpx_main();

...
import { createContext, ContextProvider, useContext, jsx, jsxs } from 'component/core';

if (!globalThis.__phpxStructMethods) { globalThis.__phpxStructMethods = Object.create(null); }
function Show() {
Ctx = globalThis.Ctx;
return jsx("span", {"children": useContext(Ctx)});
}
...
globalThis.Ctx = Ctx;
let node = jsx(ContextProvider, {"ctx": Ctx, "value": "scoped", "children": jsx(Show, {})});
globalThis.node = node;
(globalThis.__dekaPrint ? globalThis.__dekaPrint((renderToString(node) + "\n")) : console.log((renderToString(node) + "\n")));
};
await __phpx_main();

...
export function completion_json(source: string, line: number, character: number): string;

export function diagnostics_json(source: string, file_path: string, target: string): string;
...
export function hover_json(source: string, line: number, character: number): string;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
    readonly memory: WebAssembly.Memory;
    readonly completion_json: (a: number, b: number, c: number, d: number) => [number, number];
    readonly diagnostics_json: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
    readonly hover_json: (a: number, b: number, c: number, d: number) => [number, number];
